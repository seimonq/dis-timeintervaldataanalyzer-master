...
public class TestXsltTidaModel extends ModuleAndDbBasedTest {
	...
	private MetaDataModel getMetaDataModel(final String xml) {
		...
		// get the metaData
		final IMetaDataCollection collection = modulesHolder
	...
	public void testGetDescriptor() {
		...
		assertNotNull(model.<String>getDescriptorByValue("D1", "IchHabeHunger"));
		assertNotNull(model.<String>getDescriptorByValue("D1", ""));

		desModel = model.getDescriptorModel("D2");
		assertNotNull(desModel);
		assertEquals(3, desModel.size());
		assertNotNull(model.<Integer>getDescriptor("D2", 1));
		assertNotNull(model.<Integer>getDescriptor("D2", 2));
		assertNotNull(model.<Integer>getDescriptor("D2", 3));
	}
	...
	public void testTimelineWithStartEndLong() {
		...
		assertEquals(1500l, (long)def.getStart());
		assertEquals(10000l, (long)def.getEnd());
	}
	...
	public void testFullModelDataFromExternalCreation() throws IOException {
		...
		assertNotNull(m.<String>getDescriptorByValue("D1", "FIXED VALUE"));
		assertNotNull(m.<Integer>getDescriptorByValue("D2", 2));
		assertNotNull(m.<String>getDescriptorByValue("D3", "Some Value"));
		assertNotNull(m.<Double>getDescriptorByValue("D4", 1.0));
	}
