...
public class TestTimelineDefinition {
	...
	public void testIntegerTimeline() {
		...
		assertEquals(-100l, (long) def.getStart());
		assertEquals(5l, (long)def.getEnd());
	}
	...
	public void testLongTimeline() {
		final TimelineDefinition def = new TimelineDefinition(10l, 100l,
				MilliSecond.instance());
		assertEquals(Long.class, def.getType());
		assertEquals(10l,(long) def.getStart());
		assertEquals(100l, (long)def.getEnd());
	}
	...
	public void testLongWithNullValue() {
		...
		assertEquals(Long.class, def.getType());
		assertEquals(0l, (long)def.getStart());
		assertEquals(31536000000l, (long)def.getEnd());
	}
	...
	public void testLongByString() {
		final TimelineDefinition def = new TimelineDefinition("0", "100",
				MilliSecond.instance());
	...
	public void testLongByStringWithNullEnd() {
		...
		assertEquals(Long.class, def.getType());
		assertEquals(10l, (long)def.getStart());
		assertEquals(10l + TimelineDefinition.OFFSET, (long)def.getEnd());
	}
	...
	public void testLongByStringWithNullStart() {
		...
		assertEquals(Long.class, def.getType());
		assertEquals(99l, (long)def.getStart());
		assertEquals(100l,(long) def.getEnd());
	}
