...
/**
 * Test Series 1 - Performance Test for Preaggregates for DescriptorMember
 * 
 * @author skern
 *
 */
public class TestSelectPADescriptorMember {

	private final static Logger LOG = LoggerFactory.getLogger(TestSelectPADescriptorMember.class);
	...
	/*
		...
		model = loader
				.loadViaXslt("/net/kern/master/preaggregates/testCallerModel_50000.xml");
	*/	
	...
	@Test
	public void testPAOff2() {
		String query = "SELECT TIMESERIES OF count(CALLER) ON TIME.RASTER.HOUR "
				+ "FROM datasetCaller IN  [01.09.2013,15.03.2014] WHERE Caller.Physical.Gender = 'Male' OR Caller.Physical.Gender = 'Female'";
